...
from . import views
from .views import JobListView, JobCreateView, JobUpdateView, JobDeleteView, MarkEmployedView
...
urlpatterns = [
    ...
    path('jobcbv/', JobListView.as_view(), name='job_list_cbv'),
    path('job/addcbv/', JobCreateView.as_view(), name='job_add_cbv'),
    path('job/<int:pk>/editcbv/', JobUpdateView.as_view(), name='job_edit_cbv'),
    path('job/<int:pk>/deletecbv/', views.JobDeleteView.as_view(), name='job_delete_cbv'),
    path('jobs/<int:pk>/mark/', MarkEmployedView.as_view(), name='mark_employed_cbv'),
